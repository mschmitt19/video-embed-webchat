...
import {
    ...
    ACTION_START_VIDEO_SESSION,
    ACTION_UPDATE_PRE_ENGAGEMENT_DATA,
    ACTION_STOP_VIDEO_SESSION
} from "./actionTypes";
...
export function startVideoSession(code: string) {
    console.log("startVideoSession called");
    return {
        type: ACTION_START_VIDEO_SESSION,
        payload: {
            code
        }
    };
...
export function stopVideoSession() {
    console.log("stopVideoSession called");
    return {
        type: ACTION_STOP_VIDEO_SESSION,
        payload: {}
    };
}
