...
import { VideoMessageAttributes } from "../definitions";
import { JoinVideoMessage } from "./JoinVideoMessage";
...
export const MessageBubble = ({
    ...
    const messageAttributes: VideoMessageAttributes = message.attributes;
        ...
        >
            <Box {...bubbleAndAvatarContainerStyles}>
                ...
                <Box {...getInnerContainerStyles(belongsToCurrentUser)}>
                    {messageAttributes.hasVideo ? (
                        <JoinVideoMessage uniqueCode={messageAttributes.uniqueCode} />
                    ) : (
                        <>
